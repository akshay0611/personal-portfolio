...
export default function Navbar() {
	...
	return (
		...
		>
			<div className='max-w-6xl backdrop-blur-md rounded-xs md:mx-auto flex justify-between items-center bg-gray-900 bg-opacity-70 px-5 sm:px-6 md:px-10 lg:px-20 py-1 h-12 md:my-2'>
				<LinkScroll
					spy={true}
					smooth={true}
					offset={-32}
